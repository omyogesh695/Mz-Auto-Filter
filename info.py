...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002163064206')
...
SHORTLINK_API = environ.get("SHORTLINK_API", "2cbff96679f8bc257ae0016cc0b225c9e41a1350")
VERIFY_EXPIRE = int(environ.get('VERIFY_EXPIRE', 60)) # Add time in seconds
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002150303936")
if len(BIN_CHANNEL) == 0:
    print('Error - BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "https://mz-auto-filter-dua6.onrender.com")
if len(URL) == 0:
